@include("Dashboard.src.partials.main")

    <head>
        @include("Dashboard.src.partials.title-meta", ["title"=> "Landrick"])
        <!-- Css -->
        <link href="assets/libs/simplebar/simplebar.min.css" rel="stylesheet">
        @include("Dashboard.src.partials.head-css")
    </head>

    @include("Dashboard.src.partials.body")
        ...
        <!-- javascript -->
        @include("Dashboard.src.partials.vendor-scripts")
