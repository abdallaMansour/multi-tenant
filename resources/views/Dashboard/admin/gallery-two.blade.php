                    ...
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-capitalize active" aria-current="page">Gallary</li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="row row-cols-md-2 row-cols-lg-4 row-cols-xl-5 row-cols-1">
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/3.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/2.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Mockup Collection</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Abstract images</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/4.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/4.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Yellow bg with Books</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Company V-card</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/6.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/6.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Mockup box with paints</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/7.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/7.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Coffee cup</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/8.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/8.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Pen and article</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/9.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/9.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">White mockup box</a></h5>
                            ...
                            <div class="col mt-4">
                                <div class="card border-0 work-container work-classic rounded overflow-hidden">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/10.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/10.jpg" class="img-fluid" alt="work-image">
                                        </a>
                                        <div class="content p-3">
                                            <h5 class="mb-0"><a href="javascript:void(0)" class="text-dark title">Logo Vectors</a></h5>
