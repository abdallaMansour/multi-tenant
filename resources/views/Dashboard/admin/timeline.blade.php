                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Timeline Page</h5>

                            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item text-capitalize"><a href="index.html">Landrick</a></li>
                                    <li class="breadcrumb-item text-capitalize active" aria-current="page">Timeline</li>
                                </ul>
                            </nav>
                        </div>
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="timeline-page pt-2 position-relative">
                                            <div class="timeline-item mt-4">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="duration date-label-left border rounded p-2 px-4 position-relative shadow bg-white-color">2002</div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="timeline-item mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 order-sm-2 order-1">
                                                        <div class="duration duration-right rounded border p-2 px-4 position-relative shadow text-start bg-white-color">2006</div>
                                                    </div><!--end col-->
                                                </div><!--end row-->
                                            </div><!--end timeline item-->
                                            ...
                                            <div class="timeline-item mt-4">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="duration date-label-left border rounded p-2 px-4 position-relative shadow bg-white-color">2012</div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="card event event-description-right rounded shadow border-0 overflow-hidden float-start">
                                                            <div class="card-body">
                                            ...
                                            <div class="timeline-item mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 order-sm-2 order-1">
                                                        <div class="duration duration-right rounded border p-2 px-4 position-relative shadow text-start bg-white-color">2013</div>
                                                    </div><!--end col-->
                                                </div><!--end row-->
                                            </div><!--end timeline item-->
                                            ...
                                            <div class="timeline-item mt-4">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="duration date-label-left border rounded p-2 px-4 position-relative shadow bg-white-color">2016</div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="card event event-description-right rounded shadow border-0 overflow-hidden float-start">
                                                            <div class="card-body">
                                            ...
                                            <div class="timeline-item mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 order-sm-2 order-1">
                                                        <div class="duration duration-right rounded border p-2 px-4 position-relative shadow text-start bg-white-color">2018</div>
                                                    </div><!--end col-->
                                                </div><!--end row-->
                                            </div><!--end timeline item-->
