        ...
        <div class="container-fluid">
            <div class="layout-specing">
                <div class="d-md-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ __('packages.edit_package') }}</h5>
                    ...
                    <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                        <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                            ...
                            <li class="breadcrumb-item text-capitalize active" aria-current="page">{{ __('packages.breadcrumb_edit') }}</li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <div class="col-12 mt-4">
                        <div class="card border-0 rounded shadow">
                            <div class="card-header bg-transparent border-bottom p-3">
                                <h5 class="mb-0">{{ __('packages.edit_package_form') }}: {{ $package->name }}</h5>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('plan') is-invalid @enderror" id="plan" name="plan" required>
                                                ...
                                                <option value="monthly" {{ old('plan', $package->plan) == 'monthly' ? 'selected' : '' }}>{{ __('packages.monthly') }}</option>
                                                <option value="yearly" {{ old('plan', $package->plan) == 'yearly' ? 'selected' : '' }}>{{ __('packages.yearly') }}</option>
                                            </select>
                                            @error('plan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex gap-2">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="ti ti-check me-1"></i> {{ __('packages.update_package') }}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
