                    ...
                    <div class="layout-specing">
                        ...
                        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-2 row-cols-1">
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s1.jpg" class="img-fluid" alt=""></a>
                                        ...
                                        <ul class="list-unstyled shop-icons">
                                            ...
                                            <li class="mt-2"><a href="product-detail.html" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="eye" class="icons"></i></a></li>
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Branded T-Shirt</a>
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s2.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Shopping Bag</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s3.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Elegent Watch</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s4.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Casual Shoes</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s5.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Earphones</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s6.jpg" class="img-fluid" alt=""></a>
                                        ...
                                        <ul class="list-unstyled shop-icons">
                                            <li><a href="product-detail.html" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="eye" class="icons"></i></a></li>
                                        </ul>
                                    </div>
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Elegent Mug</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s7.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Sony Headphones</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s8.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Wooden Stools</a>
                                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s9.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Coffee Cup / Mug</a>
                                        <div class="d-flex justify-content-between mt-1">
                                            <h6 class="text-dark small fst-italic mb-0 mt-1">$16.00 <del class="text-danger ms-2">$21.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s10.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Sunglasses</a>
                                        <div class="d-flex justify-content-between mt-1">
                                            <h6 class="text-dark small fst-italic mb-0 mt-1">$21.00 <del class="text-danger ms-2">$25.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-6 mt-4">
                                <a href="javascript:void(0)" class="card explore-feature border-0 rounded text-center">
                                    <div class="card-body">
                                        <img src="assets/images/shop/categories/fashion.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="content mt-3">
                                            <h6 class="mb-0 text-dark">Fashion</h6>
                                        </div>
                                    </div>
                                </a>
                            </div><!--end col-->
                            <div class="col-lg-2 col-md-4 col-6 mt-4">
                                <a href="javascript:void(0)" class="card explore-feature border-0 rounded text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="content mt-3">
                                            <h6 class="mb-0 text-dark">Sports</h6>
                                        </div>
                                    </div>
                                </a>
                            </div><!--end col-->
                            <div class="col-lg-2 col-md-4 col-6 mt-4">
                                <a href="javascript:void(0)" class="card explore-feature border-0 rounded text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="content mt-3">
                                            <h6 class="mb-0 text-dark">Music</h6>
                                        </div>
                                    </div>
                                </a>
                            </div><!--end col-->
                            <div class="col-lg-2 col-md-4 col-6 mt-4">
                                <a href="javascript:void(0)" class="card explore-feature border-0 rounded text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="content mt-3">
                                            <h6 class="mb-0 text-dark">Furniture</h6>
                                        </div>
                                    </div>
                                </a>
                            </div><!--end col-->
                            <div class="col-lg-2 col-md-4 col-6 mt-4">
                                <a href="javascript:void(0)" class="card explore-feature border-0 rounded text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="content mt-3">
                                            <h6 class="mb-0 text-dark">Electronics</h6>
                                        </div>
                                    </div>
                                </a>
                            </div><!--end col-->
                            <div class="col-lg-2 col-md-4 col-6 mt-4">
                                <a href="javascript:void(0)" class="card explore-feature border-0 rounded text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="content mt-3">
                                            <h6 class="mb-0 text-dark">Mobiles</h6>
                                        </div>
                                    </div>
                                </a>
                            </div><!--end col-->
                        ...
                        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-2 row-cols-1">
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s12.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">T-Shirts</a>
                                        <div class="d-flex justify-content-between mt-1">
                                            <h6 class="text-dark small fst-italic mb-0 mt-1">$18.00 <del class="text-danger ms-2">$22.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s13.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Wooden Chair</a>
                                        <div class="d-flex justify-content-between mt-1">
                                            <h6 class="text-dark small fst-italic mb-0 mt-1">$16.00 <del class="text-danger ms-2">$21.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s14.jpg" class="img-fluid" alt=""></a>
                                        <div class="overlay-work">
                                            <div class="py-2 bg-soft-dark out-stock">
                                                <h6 class="mb-0 text-center">Out of stock</h6>
                                            </div>
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Women Block Heels</a>
                                        <div class="d-flex justify-content-between mt-1">
                                            <h6 class="text-dark small fst-italic mb-0 mt-1">$21.00 <del class="text-danger ms-2">$25.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s15.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                            ...
                            <div class="col mt-4">
                                <div class="card shop-list border-0 overflow-hidden rounded">
                                    ...
                                    <div class="shop-image position-relative overflow-hidden">
                                        <a href="product-detail.html"><img src="assets/images/shop/product/s16.jpg" class="img-fluid" alt=""></a>
                                        <a href="product-detail.html" class="overlay-work">
                                    ...
                                    <div class="card-body content p-3 border-top">
                                        <a href="product-detail.html" class="text-dark product-name h6">Clock</a>
                                        <div class="d-flex justify-content-between mt-1">
                                            <h6 class="text-dark small fst-italic mb-0 mt-1">$18.00 <del class="text-danger ms-2">$22.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
