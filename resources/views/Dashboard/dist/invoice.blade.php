                        ...
                        <div class="row mt-4">
                            <div class="col">
                                        ...
                                        <div class="invoice-top pb-4 border-bottom">
                                            <div class="row">
                                                <div class="col-xl-9 col-md-8">
                                                    <div class="logo-invoice mb-2"><img src="assets/images/logo-dark.png" height="24" alt=""></div>
                                                    <a href="javascript:void(0)" class="text-primary h6"><i data-feather="link" class="fea icon-sm text-muted me-2"></i>www.landrick.corp</a>
                                                </div><!--end col-->
                                ...
                                <div class="mt-4 text-end">
                                    <a href="javascript:window.print()" class="btn btn-icon btn-soft-primary d-print-none"><i class="ti ti-printer"></i></a>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </div>
