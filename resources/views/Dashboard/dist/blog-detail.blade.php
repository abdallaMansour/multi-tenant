                    ...
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-capitalize"><a href="#">Blog</a></li>
                                    <li class="breadcrumb-item text-capitalize active" aria-current="page">Design your apps in your own way</li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-6 mt-4">
                                <div class="card blog blog-primary blog-detail border-0 shadow rounded">
                                    ...
                                    <div class="card-body content">
                                        ...
                                        <h4 class="mt-3">Design your apps in your own way</h4>
                                            ...
                                            <div class="col-lg-6 mt-4">
                                                <div class="card blog blog-primary rounded border-0 shadow">
                                                    ...
                                                    <div class="author">
                                                        ...
                                                        <small class="text-white date"><i class="uil uil-calendar-alt"></i> 25th June 2021</small>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                            ...
                            <div class="col-lg-3 col-md-6 col-12 mt-4">
                                ...
                                <div class="card border-0 widget rounded shadow p-4 widget mt-4">
                                    <!-- TAG CLOUDS -->
                                    <div class="text-center">
                                        <h5 class="mb-0">Tagclouds</h5>
                                    </div> 
