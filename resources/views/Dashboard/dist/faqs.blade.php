...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <!-- Start Modal -->
        <div class="modal fade" id="add-faqs" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input name="name" id="name" type="text" class="form-control" placeholder="Question :">
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="comments" id="comments" rows="4" class="form-control" placeholder="Answer :"></textarea>
                                    </div>
                                </div><!--end col-->
