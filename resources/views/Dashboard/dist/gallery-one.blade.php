                    ...
                    <div class="layout-specing">
                        ...
                        <div class="row row-cols-md-2 row-cols-lg-4 row-cols-xl-5 row-cols-1">
                            ...
                            <div class="col mt-4">
                                <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/11.jpg" class="lightbox d-inline-block" title="">
                            ...
                            <div class="col mt-4">
                                <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/12.jpg" class="lightbox d-inline-block" title="">
                            ...
                            <div class="col mt-4">
                                <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                                    <div class="card-body p-0">
                                        <a href="assets/images/work/2.jpg" class="lightbox d-inline-block" title="">
                                            <img src="assets/images/work/2.jpg" class="img-fluid rounded" alt="work-image">
                                        </a>
                                    </div>
                                </div>
