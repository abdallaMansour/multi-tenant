                        ...
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-capitalize active" aria-current="page">Alert</li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-4">
                                <div class="card rounded shadow">
                                    ...
                                    <div class="p-4">
                                        <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;div class="alert bg-soft-primary fw-medium" role="alert"&gt; &lt;i class="uil uil-info-circle fs-5 align-middle me-1"&gt;&lt;/i&gt; An example alert with an icon &lt;/div&gt;</code></h6>
                                        ...
                                        <div class="alert bg-soft-success fw-medium" role="alert"><i class="uil uil-check-circle fs-5 align-middle me-1"></i> An example success alert with an icon</div>
                                        <div class="alert bg-soft-warning fw-medium" role="alert"><i class="uil uil-exclamation-triangle fs-5 align-middle me-1"></i> An example warning alert with an icon</div>
                                        <div class="alert bg-soft-danger fw-medium" role="alert"><i class="uil uil-exclamation-octagon fs-5 align-middle me-1"></i> An example danger alert with an icon</div>
                                    </div>
                                </div>
                            </div><!--end col-->
                            <!-- Alert Links End -->
                            ...
                            <div class="col-lg-6 mt-4">
                                <div class="card rounded shadow">
                                    <div class="p-4 border-bottom">
                                        <h5 class="title mb-0"> Additional Content </h5>
                                    </div>
                            ...
                            <div class="col-lg-6 mt-4">
                                <div class="card rounded shadow">
                                    <div class="p-4 border-bottom">
                                        <h5 class="title mb-0"> Advanced Alert </h5>
                                    </div>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="d-block">
                                            <div class="alert alert-primary alert-pills" role="alert">
                                                ...
                                                <span class="content"> A Modern primary alert—check it out! <i class="uil uil-angle-right-b"></i></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-block">
                                            <div class="alert alert-danger alert-pills mb-0" role="alert">
                                                ...
                                                <span class="content"> A Modern danger alert—check it out! <i class="uil uil-angle-right-b"></i> </span> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 mt-4">
                                <div class="card rounded shadow">
                                    <div class="p-4 border-bottom">
                                        <h5 class="title mb-0"> Advanced Outline Alert </h5>
                                    </div>
