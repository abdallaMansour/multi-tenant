                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-capitalize"><a href="#">Shop</a></li>
                                    <li class="breadcrumb-item text-capitalize active" aria-current="page">Shop Cart</li>
                                </ul>
                            </nav>
                        </div>
                                    ...
                                    <table class="table mb-0 table-center">
                                        ...
                                        <tbody>
                                            <tr class="shop-list">
                                                ...
                                                <td class="text-end fw-bold pe-4">$510.00</td>
                                            </tr>
                                            ...
                                            <tr class="shop-list">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/shop/product/s10.jpg" class="img-fluid avatar avatar-small rounded shadow" style="height:auto;" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 ms-auto mt-4">
