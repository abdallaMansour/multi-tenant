                        ...
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-capitalize"><a href="#">Apps</a></li>
                        ...
                        <div class="row g-2">
                            <div class="col-xl-3 col-lg-5 col-md-5 col-12 mt-4">
                                <div class="card border-0 rounded shadow">
                                    ...
                                    <div class="p-2 chat chat-list" data-simplebar style="max-height: 507px;">
                                        ...
                                        <a href="#" class="d-flex chat-list p-2 mt-2 rounded position-relative">
                                            ...
                                            <div class="overflow-hidden flex-1 ms-2">
                                                ...
                                                <div class="justify-content-between">
                                                    <span class="badge bg-soft-danger float-end">2</span>
                                                    <span class="text-dark h6 mb-0 text-truncate">Hi, How are you?</span>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#" class="d-flex chat-list p-2 mt-2 rounded position-relative">
                                            <div class="position-relative">
                                                <img src="assets/images/client/11.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                                <i class="mdi mdi-checkbox-blank-circle text-success on-off align-text-bottom"></i>
                                            </div>
                                            <div class="overflow-hidden flex-1 ms-2">
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <a href="#" class="d-flex chat-list p-2 mt-2 rounded position-relative">
                                            <div class="position-relative">
                                                <img src="assets/images/client/12.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                                <i class="mdi mdi-checkbox-blank-circle text-success on-off align-text-bottom"></i>
                                            </div>
                                            <div class="overflow-hidden flex-1 ms-2">
                                                <div class="d-flex justify-content-between">
                            ...
                            <div class="col-xl-9 col-lg-7 col-md-7 col-12 mt-4">
                                <div class="card chat chat-person border-0 shadow rounded">
                                    <div class="d-flex justify-content-between align-items-center border-bottom p-4">
                                        <div class="d-flex">
                                            ...
                                            <div class="overflow-hidden ms-3">
                                                <a href="#" class="text-dark mb-0 h6 d-block text-truncate">Calvin Carlo</a>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li class="dropdown dropdown-primary list-inline-item">
                                                ...
                                                <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3">
                                                    <a class="dropdown-item text-dark" href="#"><span class="mb-0 d-inline-block me-1"><i class="ti ti-user"></i></span> Profile</a>
                                                    <a class="dropdown-item text-dark" href="#"><span class="mb-0 d-inline-block me-1"><i class="ti ti-settings"></i></span> Profile Settings</a>
                                    ...
                                    <ul class="p-4 list-unstyled mb-0 chat" data-simplebar style="background: url('assets/images/account/bg-chat.png') center center; max-height: 558px;">
                                        <li>
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Hey Cristina</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>59 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="chat-right">
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Hello Calvin</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>45 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="chat-right">
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">How can i help you?</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>44 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Nice to meet you</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>42 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Hope you are doing fine?</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>40 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">I am intrested to know more about your prices and services you offer</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>35 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="chat-right">
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Sure please check below link to find more useful information <a href="https://1.envato.market/landrick" target="_blank" class="text-primary">https://shreethemes.in/landrick/</a></p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>25 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Thank you 😊</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>20 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="chat-right">
                                            <div class="d-inline-block">
                                                <div class="d-flex chat-type mb-3">
                                                    ...
                                                    <div class="chat-msg" style="max-width: 500px;">
                                                        <p class="msg text-muted small shadow px-3 py-2 rounded mb-1">Welcome</p>
                                                        <small class="text-muted msg-time"><i class="ti ti-clock me-1"></i>18 min ago</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <div class="p-2 rounded-bottom shadow">
                                        <div class="row g-2">
                                            <div class="col">
                                                <input type="text" class="form-control border" style="height: 36px;" placeholder="Enter Message...">
                                            </div>
                                            <div class="col-auto">
                                                <a href="#" class="btn btn-icon btn-primary"><i class="ti ti-send"></i></a>
                                                <a href="#" class="btn btn-icon btn-primary"><i class="ti ti-mood-smile"></i></a>
                                                <a href="#" class="btn btn-icon btn-primary"><i class="ti ti-paperclip"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
