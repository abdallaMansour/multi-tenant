<!doctype html>
<html lang="en" dir="{{ (authUser()?->default_lang ?? app()->getLocale()) == 'ar' ? 'rtl' : 'ltr' }}">
...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('assets_dashboard/css/bootstrap'. (authUser()?->color_mode == 'dark' ? '-dark' : '') . ((authUser()->default_lang ?? app()->getLocale()) == 'ar' ? '-rtl' : '') .'.min.css') }}" class="theme-opt" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    ...
    <!-- Style Css-->
    <link href="{{ asset('assets_dashboard/css/style'. (authUser()?->color_mode == 'dark' ? '-dark' : '') . ((authUser()->default_lang ?? app()->getLocale()) == 'ar' ? '-rtl' : '') .'.min.css') }}" class="theme-opt" rel="stylesheet" type="text/css" />
    <style>
        .custom-logo {
            text-align: center;
