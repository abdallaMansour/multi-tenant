<!doctype html>
<html lang="en" dir="{{ (auth()->user()->default_lang ?? app()->getLocale()) == 'ar' ? 'rtl' : 'ltr' }}">
...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('assets_dashboard/css/bootstrap'. (auth()->user()->color_mode == 'dark' ? '-dark' : '') . ((auth()->user()->default_lang ?? app()->getLocale()) == 'ar' ? '-rtl' : '') .'.min.css') }}" class="theme-opt" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    ...
    <!-- Style Css-->
    <link href="{{ asset('assets_dashboard/css/style'. (auth()->user()->color_mode == 'dark' ? '-dark' : '') . ((auth()->user()->default_lang ?? app()->getLocale()) == 'ar' ? '-rtl' : '') .'.min.css') }}" class="theme-opt" rel="stylesheet" type="text/css" />
    <style>
        .custom-logo {
            text-align: center;
