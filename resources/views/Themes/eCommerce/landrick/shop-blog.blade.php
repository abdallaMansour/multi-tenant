                    ...
                    <div class="col-lg-4 col-md-6 mb-4 pb-2">
                        <div class="card blog blog-primary border-0 shadow rounded overflow-hidden">
                            ...
                            <div class="card-body content">
                                ...
                                <a href="shop-blog-detail.html" class="text-dark title h5">A team of designers that make dreams come true</a>
                                
                                <div class="mt-2">
                                    <a href="shop-blog-detail.html" class="text-primary">Read more <i data-feather="arrow-right" class="fea icon-sm"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>{{-- end col --}}
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 pb-2">
                        <div class="card blog blog-primary border-0 shadow rounded overflow-hidden">
                            ...
                            <div class="card-body content">
                                ...
                                <a href="shop-blog-detail.html" class="text-dark title h5">The best ways to change your summer</a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 pb-2">
                        <div class="card blog blog-primary border-0 shadow rounded overflow-hidden">
                            ...
                            <div class="card-body content">
                                ...
                                <a href="shop-blog-detail.html" class="text-dark title h5">Men’s fashion & shopping in leather</a>
