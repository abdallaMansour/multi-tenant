                ...
                <div class="row">
                    <div class="col-md-4 mt-4 pt-2">
                        <ul class="nav nav-pills nav-justified flex-column rounded shadow p-3 mb-0" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" role="tab" href="auth-login.html" aria-selected="false">
                                    <div class="text-start py-1 px-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user-check" class="fea icon-sm icons"></i>
                                                    <input name="name" id="display-name" type="text" class="form-control ps-5" value="cally_joseph">
                                                </div>
                                            </div> 
                                        </div>{{-- end col --}}
