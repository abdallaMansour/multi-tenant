                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <h4 class="title mb-0"> Fullwidth List Products </h4>
                        </div>
                    </div>{{-- end col --}}
                </div>{{-- end row --}}
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="d-flex justify-content-md-between align-items-center">
                            ...
                            <div class="mx-2">
                                <a href="shop-fullwidth-grids.html" class="h5 text-muted"><i class="uil uil-apps"></i></a>
                            </div>

                            <div>
                                <a href="shop-fullwidth-lists.html" class="h5 text-muted"><i class="uil uil-list-ul"></i></a>
                            </div>
                        </div>
                    </div>{{-- end col --}}
                </div>{{-- end row --}}
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$16.00 <del class="text-danger ms-2">$21.00</del> </h6>
                                        ...
                                        <p class="para-desc text-muted mb-1">This is required when, for example, the final text is not yet available. Dummy text is also known as 'fill text'.</p>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$21.00 <del class="text-danger ms-2">$25.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$5.00 <span class="text-success ms-1">30% off</span> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$18.00 <del class="text-danger ms-2">$22.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$3.00</h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$4.50 <del class="text-danger ms-2">$6.50</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$9.99 <span class="text-success ms-2">20% off</span> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                            ...
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="card-body content p-4">
                                        ...
                                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                                            <h6 class="text-muted small fst-italic mb-0 me-3">$22.00 <del class="text-danger ms-2">$25.00</del> </h6>
                                            <ul class="list-unstyled text-warning mb-0">
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
                                                <li class="list-inline-item"><i class="mdi mdi-star"></i></li>
