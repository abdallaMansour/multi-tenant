                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <h4 class="title mb-0"> Branded T-Shirts </h4>
                        </div>
                    </div>{{-- end col --}}
                </div>{{-- end row --}}
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="shop-product-detail.html" class="text-dark align-items-center">
                                        ...
                                        <img src="assets/images/work/6.jpg" class="avatar avatar-small rounded shadow ms-2" style="height:auto;" alt="">
                                    </a>
                                    ...
                                    <a href="shop-product-detail.html" class="text-dark align-items-center">
                                        <img src="assets/images/work/7.jpg" class="avatar avatar-small rounded shadow me-2" style="height:auto;" alt="">
