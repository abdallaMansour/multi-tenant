                ...
                <div class="row">
                    <div class="col-12 p-0">
                        <div class="d-flex flex-column min-vh-100 p-4">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div class="mb-3">
                                                        <div class="form-check align-items-center d-flex mb-0">
                                                            ...
                                                            <label class="form-check-label text-muted ms-2 mb-0" for="RememberMe">Remember me</label>
                                                        </div>
                                                    </div>
                                                    <small class="text-muted mb-0"><a href="auth-reset-password-bg-video.html" class="text-muted fw-semibold">Forgot password ?</a></small>
                                                </div>
                                            </div>{{-- end col --}}
                                            ...
                                            <div class="col-12 text-center mt-4">
                                                <small><span class="text-muted me-2">Don't have an account ?</span> <a href="auth-signup-bg-video.html" class="text-dark fw-bold">Sign Up</a></small>
                                            </div>{{-- end col --}}
                                        </div>{{-- end row --}}
                                    </form>
                                </div>
                            ...
                            {{-- Start Footer  --}}
                            <div class="text-center">
                                <p class="mb-0 text-white">© <script>document.write(new Date().getFullYear())</script> Landrick. Design with <i class="mdi mdi-heart text-danger"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                            </div>
                            {{-- End Footer  --}}
                        </div>
                    </div>{{-- end col --}}
